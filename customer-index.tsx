...
console.log('✅ Customer-index.tsx loaded');

const CustomerAppContent: React.FC = () => {
  console.log('🔍 CustomerAppContent rendering');
  const { user } = useApp();
      ...
      <div className="bg-slate-900 text-white z-[100] shadow-xl border-b border-slate-800">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold tracking-tighter hidden sm:inline">CUSTOMER PORTAL</span>
          </div>
